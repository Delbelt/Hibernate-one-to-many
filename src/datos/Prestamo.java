...
public class Prestamo {
	...
	public boolean equals(Object obj) {
		...
		Prestamo objeto = (Prestamo) obj;
		
		return  objeto.getCliente().equals(this.getCliente()) &&
				objeto.getFecha().isEqual(this.getFecha()) &&
				objeto.getIdPrestamo() == this.idPrestamo;		
	}
	...
	{	
		...
		Set<Cuota> cuotas= new HashSet<Cuota>();
			...
			//Verifica que el vencimiento no caiga en fin de semana
			...
			for(int i = 1; i <= cantCuotas ; i++) 
			{
				...
				cuotas.add(new Cuota(i, fechaVencimiento, saldoPendiente, 
				amortizacion, interesCuota, cuota, deuda, false, fechaVencimiento, 0, p));
