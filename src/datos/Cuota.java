...
public class Cuota {
	...
	public Cuota(int nroCuota, LocalDate fechaVencimiento, double saldoPendiente, double amortizacion, double interesCuota, 
			double cuota, double deuda, boolean cancelada, LocalDate fechaDePago, double punitorios, Prestamo prestamo)
	{
		super();
	...
	public boolean equals(Object obj) {
		Cuota objeto = (Cuota) obj;
		
		return  objeto.getNroCuota() == this.getNroCuota() &&
				objeto.getPrestamo().equals(this.getPrestamo());
	}	
}
